	...
	return (
		...
		>
			...
			<ul>
				...
				<li>
					See the list of possible chords to determine what your chord might be,
					a red chord means an exact match
				</li>
				<li>
				...
				<li>
					...
					toggle from sharps to flats, or have the chord played as a block or an
					arpeggio
				</li>
				<button
					className="uiButton instructionsButton closeButton pointer"
